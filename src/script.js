...
const configurePlayPauseBtn = function (playerPaused) {
  ...
  playerPaused
    ? btn.classList.add('fa', 'fa-play')
    : btn.classList.add('fa', 'fa-pause');
};
...
const updateProgressSection = function () {
  durationStart.textContent = musicPlayer.currentTime
    ? formatTime(musicPlayer.currentTime)
    : '00:00';
  durationEnd.textContent = musicPlayer.duration
